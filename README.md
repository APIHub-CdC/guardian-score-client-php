# guardian-score-client-php[![GitHub Packages](https://img.shields.io/badge/Maven&nbsp;package-Last&nbsp;version-lemon)](https://github.com/orgs/APIHub-CdC/packages?repo_name=guardian-score-client-php) 
...
### Paso 4. Modificar URL y credenciales
 ...
 Modificar la URL y las credenciales de acceso a la petición en ***test/Api/GuardIAnScoreApiTest.php***, como se muestra en el siguiente fragmento de código:
