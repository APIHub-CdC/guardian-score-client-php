...
namespace GuardianScore\Client\Interceptor;
...
use \GuardianScore\Client\Interceptor\KeyHandler;
use \GuardianScore\Client\Interceptor\MyLogger;
use \GuardianScore\Client\Model\Errors;
use \GuardianScore\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\GuardianScore\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \GuardianScore\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \GuardianScore\Client\Model\Errores(["errors" => [$error]]);
